...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredAsWellAsOptionalWithNoAvailability() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times, and the optional attendee has no availability, so they are ignored.
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyOptionalAttendeeIsConsideredAndNoAvailability() {
    // Have each optional person have different events, but with no open space for a meeting. We should see no options because each person has
    // no open time.
    //
    // Optional: |--A--||--------B-------------|
    // Day     : |-----------------------------|
